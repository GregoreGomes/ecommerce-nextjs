...
export default function Admin() {
  ...
  const refImage = storageRef(storage, `produtos/${titleProduct}`);
  ...
  return (
    ...
    <div className="flex gap-40 ">
      <div className=" flex justify-center items-center h-screen w-2/4 ml-14 flex-col">
      <form onSubmit={handleSubmit} className="w-full mx-auto p-8 rounded-2xl border-black border-[1px]">
        <h1 className="text-black text-xl pb-6">Adicione um produto</h1>
      ...
      <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-200 ">
        ...
        {/* <UploadFile imageName={titleProduct}/> */}
    ...
    {!isUserAdmin && (
      <h1 className="flex justify-center items-start h-screen text-2xl text-red-600">Você não tem permissão para acessar essa página</h1>
    )}
    </>
  );
}